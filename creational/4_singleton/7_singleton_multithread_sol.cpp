...
Logger& Logger::Instance(){
	// Since Instance is a static-member function. And since static methods can access
	// only static member functions, thus mutex object has to be static.
	m_Mtx.lock();
...
int main() {
	...
	/*
		...
		The solution to this is to use "lock" in the Instance() method.
		We can use mutex, it needs to be static(otherwise we won't be able to access it!)
